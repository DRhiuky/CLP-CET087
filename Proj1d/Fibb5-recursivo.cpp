...
code[ 0].f = INT; code[ 0].l = 0; code[ 0].a =  5; // Reserva 5 espaço na pilha
code[ 1].f = LIT; code[ 1].l = 0; code[ 1].a =  5; // Parâmetro da função n = 5
code[ 2].f = STO; code[ 2].l = 0; code[ 2].a =  3; // Armazena n na posição 3
code[ 3].f = LOD; code[ 3].l = 0; code[ 3].a =  3; // carrega o valor de n na posição 3
code[ 4].f = STO; code[ 4].l = 0; code[ 4].a =  8; // Armazena em topo + 3;
  
code[ 5].f = CAL; code[ 5].l = 0; code[ 5].a =  9; // Chama a função fib(n)
    
code[ 6].f = LOD; code[ 6].l = 0; code[ 6].a =  9; // carrega resultado da funcao
...
code[17].f = STO; code[17].l = 0; code[17].a =  8; // armazena como parâmetro o novo valor
code[18].f = CAL; code[18].l = 0; code[18].a =  9; // chama fib(n-1)

code[19].f = LOD; code[19].l = 0; code[19].a =  3; // carrega o valor de n armazenado em 3 e coloca no topo
code[20].f = LIT; code[20].l = 0; code[20].a =  2; // 2 no topo para fazer a subtração de n
code[21].f = OPR; code[21].l = 0; code[21].a =  3; // subtrai 2 de n
...
code[27].f = STO; code[27].l = 0; code[27].a =  4; // Armazena o resultado da soma

code[28].f = JMP; code[28].l = 0; code[28].a = 31; // Pula o próximo trecho de código

code[29].f = LOD; code[29].l = 0; code[29].a =  3; // carrega o valor de n armazenado em 3 e coloca no topo
code[30].f = STO; code[30].l = 0; code[30].a =  4; // Salva o resultado da recursão em tmp

code[31].f = OPR; code[31].l = 0; code[31].a =  0; // RETURN // fib-FIM
